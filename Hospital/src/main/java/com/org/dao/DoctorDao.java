...
public class DoctorDao {
	...
	public boolean editDoctorProfile(Doctor d) {
	 ...
	 public boolean cloneDoctor(Doctor originalDoctor) {
	        boolean success = false;
	        try {
	            // Clonează doctorul original
	            Doctor clonedDoctor = (Doctor) originalDoctor.clone();
	            clonedDoctor.setId(0); // Setează id-ul la 0 pentru a fi generat automat

	            // Salvează doctorul clonat în baza de date
	            success = registerDoctor(clonedDoctor);
