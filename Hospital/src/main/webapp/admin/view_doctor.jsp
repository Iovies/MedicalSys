                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="${pageContext.request.contextPath}/admin/CloneDoctor" method="post" style="display:inline;">
                                            <input type="hidden" name="doctorId" value="<%= d.getId() %>">
                                            <button type="submit" class="btn btn-sm btn-info">Clone</button>
                                        </form>
                                    </td>
                                </tr>
                                <%
